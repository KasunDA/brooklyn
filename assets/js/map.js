...
function initialize() {
    ...
    //インフォウィンドウ　ブルックリン
    var contentString_broolkyn =  'BROOKLYN'+'<p>〒814-0002<br>福岡市早良区西新5-4-20<br>tel.092-843-8186</p>'; 
    var infowindow_broolkyn = new google.maps.InfoWindow({
        content: contentString_broolkyn
    });

    //インフォウィンドウ　ロータス
    var contentString_lotus =  'LOTUS'+'<p>〒810-0021<br>福岡県福岡市中央区今泉1-19-10天神ソ二ック101<br>tel.092-751-0606</p>'; 
    var infowindow_lotus = new google.maps.InfoWindow({
        content: contentString_lotus
    });

    //アイコン ブルックリ
    var image_broolkyn = '/assets/img/shop-info/icon_map.png'; //マーカーアイコン画像URL
    var marker_broolkyn = new google.maps.Marker({
        position: new google.maps.LatLng(33.581618, 130.356924),  //マーカ位置
        map: map,
        icon:image_broolkyn, //アイコン画像をセット
        title: 'ブルックリン',
